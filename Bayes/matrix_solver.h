...
namespace LINALG
{
	...
	template <class T>
	matrix<T> matrix_complex<T>::Real()
	{
		static matrix<T> hack;

		if (hack.NumRows() != this->NumRows() || hack.NumCols() != this->NumCols())
		{
			hack.destroy();
			hack.create(this->NumRows(), this->NumCols());
	...
	template <class T>
	matrix<T> matrix_complex<T>::Imag()
	{
		static matrix<T> hack;
	...
	//============================================================================
	template <class T>
	void matrix_complex<T>::operator = (matrix<T> &b)
	{
		if (this->NumRows()!= b.NumRows() || this->NumCols() != b.NumCols())
		{
			this->destroy();
	...
	//============================================================================
	template <class T>
	void matrix<T>::operator = (matrix_complex<T> &b)
	{
		if (this->NumRows() != b.NumRows() || this->NumCols() != b.NumCols())
		{
			this->destroy();
